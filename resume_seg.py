#### resume training from previous epochs, segmentation ####
...
path_old_history = '/data/users/bpb216/results/13_09'    # path where the previous history was saved
...
path_weights = '/data/users/bpb216/results/13_09/nano_seg_lr_5.h5' #path where weightsfrom previous training were saved
...
def train(lr,i):
    ...
    print('resume training from last epoch')
    ...
    # fit the model and saving the best weights
    ...
    save_history( history, i, path_to_history, path_old_history, resume = 1 )
